...
The current issue labels being handled are enhancements and bugs.

### Enhancement Issue

This issue is meant for feature changes/enhancements. Please provide the following information:
...
Is your fork not up-to-date with the pyAFL code? Most of the time that isn't a problem. But if you like to "sync back" the changes to your repository, execute the following command:

The first time:

```
git remote add upstream https://github.com/RamParameswaran/pyAFL.git
```
